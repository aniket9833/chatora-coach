      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8 pt-30">
            ...
            <h1 className="animate-fade-in-up animation-delay-100 font-serif text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-balance">
              Fat loss coaching <span className="text-primary">Diet nahi,</span>{" "}
              portion sahi.
            </h1>

            <p className="animate-fade-in-up animation-delay-200 text-lg lg:text-xl text-muted-foreground max-w-xl leading-relaxed">
            ...
            {/* Trust Indicators */}
            <div className="animate-fade-in-up animation-delay-400 flex flex-wrap gap-6 pt-4">
          ...
          <div className="animate-fade-in-up animation-delay-300 relative">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-4 pt-8">
                <div className="bg-card p-4 rounded-xl shadow-lg border border-border">
                  <p className="text-lg font-bold text-primary mb-2">3000+</p>
