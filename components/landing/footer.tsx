      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-md text-background/90 leading-relaxed mb-1">
          ...
          {/* Col 2: Nav links */}
          <div>
            <h3 className="text-sm font-bold uppercase tracking-widest text-background/70 mb-3">
              Links
            </h3>
        ...
        {/* Bottom bar */}
        <div className="mt-8 pt-5 border-t border-background/20">
          <p className="text-sm text-background/70 text-center sm:text-center">
